    ...
    try:
        for date_index, (checkin_date, checkout_date) in enumerate(dates_to_check):
            ...
            try:
                ...
                # Extract hotels with improved price extraction and IHG filtering
                hotels = await page.evaluate('''() => {
                    ...
                    for (let i = 0; i < Math.min(cards.length, 30); i++) {
                        ...
                        // Skip IHG/InterContinental hotels if they're causing issues
                        ...
                        if (lowerText.includes('ihg') || 
                            ...
                            console.log('Skipping IHG brand hotel');
                            continue;
                        }
                        ...
                        if ((text.includes('Earn 10,000 miles') || text.includes('Earn 10000 miles')) &&
                            ...
                            // Additional validation - skip suspiciously cheap hotels
                            if (price && price < 30) {
                                console.log('Skipping suspiciously cheap hotel:', name, 'at $', price);
                                continue;
                            }
